...
class JigsawScreen(tkinter.Frame):
    def __init__(self, parent, controller):
        ...
        self.label_1 = customtkinter.CTkLabel(self.main_frame, text="Jigsaw", font=customtkinter.CTkFont(size=28, weight="normal"))
        ...
        self.normal_button = customtkinter.CTkButton(self.main_frame, text='jigsaw puzzle', command=lambda: controller.show_frame("JigsawSolverScreen"))
        self.normal_button.grid(row=5, column=0, padx=30, pady = (50,100), sticky="n")
        
        self.hint_button = customtkinter.CTkButton(self.main_frame, text='jigsaw puzzle + hint', command=lambda: controller.show_frame("JigsawWithHintSolverScreen"))
        self.hint_button.grid(row=5, column=1, padx=30, pady = (50,100), sticky="n")
        
        self.merged_button = customtkinter.CTkButton(self.main_frame, text='merged', command=lambda: controller.show_frame("JigsawMergedScreen"))
        self.merged_button.grid(row=5, column=2, padx=30, pady = (50,100), sticky="n")
